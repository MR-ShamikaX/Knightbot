...
async function sendGlobalBroadcastMessage(_0x6efd52) {
  ...
  for (const _0x596334 of userGroupData.groups) {
    ...
    await _0x6efd52.sendMessage(_0x596334, {
      'text': "🌟 This is a global broadcast message from KnightBot! Stay tuned for updates.\n✅Join our WhatsApp Channel for more bot related updates - https://whatsapp.com/channel/0029Va90zAnIHphOuO8Msp3A"
    });
  }
    ...
    if (_0x4b0f0c === "close") {
      ...
      if (_0x4b0f0c === "open") {
        ...
        await _0xd110e.sendMessage(_0x403870, {
          'text': "🎉 Congrats! The bot has been connected successfully.\n➡Join WhatsApp channel - https://whatsapp.com/channel/0029Va90zAnIHphOuO8Msp3A\n➡Bot Tutorial - www.youtube.com/@mr_unique_hacker\n➡Telegram - https://t.me/+3QhFUZHx-nhhZmY1\n------------------"
        });
      }
    }
  });
